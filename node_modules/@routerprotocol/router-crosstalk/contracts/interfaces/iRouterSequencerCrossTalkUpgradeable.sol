...
/// @title iRouterSequencerCrossTalkUpgradeable contract interface for router Crosstalk
/// @author Router Protocol
interface iRouterSequencerCrossTalkUpgradeable is IERC165Upgradeable {
  struct Params {
    uint8 _destChainID;
    bytes _erc20;
    bytes _swapData;
  ...
  /// @param genericData abi encoded selector and params data.
  function routerSync(
    uint8 srcChainID,
    address srcAddress,
