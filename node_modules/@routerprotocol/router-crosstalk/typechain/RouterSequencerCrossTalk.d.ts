...
interface RouterSequencerCrossTalkInterface extends ethers.utils.Interface {
  functions: {
    "Link(uint8,address)": FunctionFragment;
    "Unlink(uint8)": FunctionFragment;
    "erc20Handler()": FunctionFragment;
    ...
    "reserveHandler()": FunctionFragment;
    "routerSync(uint8,address,bytes)": FunctionFragment;
    "sequencerHandler()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "reserveHandler",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "sequencerHandler",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class RouterSequencerCrossTalk extends BaseContract {
  ...
  interface: RouterSequencerCrossTalkInterface;
  ...
  functions: {
    ...
    erc20Handler(overrides?: CallOverrides): Promise<[string]>;
    ...
    reserveHandler(overrides?: CallOverrides): Promise<[string]>;
    ...
    sequencerHandler(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    erc20Handler(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    reserveHandler(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    sequencerHandler(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    erc20Handler(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    reserveHandler(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    sequencerHandler(overrides?: CallOverrides): Promise<PopulatedTransaction>;
