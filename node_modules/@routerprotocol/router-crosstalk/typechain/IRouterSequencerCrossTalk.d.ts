...
interface IRouterSequencerCrossTalkInterface extends ethers.utils.Interface {
  functions: {
...
export class IRouterSequencerCrossTalk extends BaseContract {
  ...
  interface: IRouterSequencerCrossTalkInterface;
